Public Class frmAllJobs
    ...
    Private Sub frmAllJobs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim dbProvider As String
        Dim dbSource As String
        ...
        sql = "Select * FROM Jobs WHERE LinkedUser = " & SelectedUser 'Uses and SQL statement to select the Login form
